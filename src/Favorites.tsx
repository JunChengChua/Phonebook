        ...
        >
            ...
            <div className={"flex flex-grow h-[87%] m-4 mt-2.5 rounded-md bg-[#ffffff65] shadow-lg"}>
                ...
                <div className="flex flex-col flex-grow items-center h-full">
                    {/*Search Bar*/}
                    <div className="flex flex-row mt-10 w-auto justify-center items-center flex-nowrap">
                        <div className="relative" style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <input 
                                ...
                                style={{ width: searchFocused ? 'min(66vw, 720px)' : '475px', maxWidth: '525px', transition: 'width 220ms ease-in' }}
